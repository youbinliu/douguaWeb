    ...
    $pc.fn.extend({
        ...
        build: function() {
       	...
       	//create the structure for pikachoose
			...
			this.caption 	= $("#liveinfo").html("<div class='caption'></div>").hide();//youbinliu//$("<div class='caption'></div>").insertAfter(this.imgNav).hide();
        ...
        createThumb: function(ele) {
    		...
    		$('<img />').bind('load',{data:data},function(){
				...
				//add by youbinliu
				//过滤掉除了其他图片比如address.png time.png
				if(self.attr('lyb') !== "lyb") return;
